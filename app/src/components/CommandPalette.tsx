...
const COMMANDS: Command[] = [
  ...
  { id: "nav.cookies",  label: "Go to Cookies",   keywords: "jar session",   group: "Navigate", run: (c) => c.navigate("/cookies")  },
  { id: "nav.utils",    label: "Go to Utilities", keywords: "jwt base64 hash regex uuid", group: "Navigate", run: (c) => c.navigate("/utils") },
